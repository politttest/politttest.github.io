...
<body>
	<div class="header">
		...
		<div class="search_in_page">
			<form method="post" action="index.php">
				 ...
				 <input type="search" class="" maxlength="50" placeholder="Поиск по разделу" name="input2">
	...
	<div class="card">
		<div class="name_card">
			<a class="text_name_card" data-name="Название теста:" href=""><?php echo($array[1+$i*6]);?></a>
		</div>
		<div class="content">
